package ru.andreysozonov.notes.ui.customviews
...
class ColorCircleView @JvmOverloads constructor(
    ...
    @ColorRes
    var strokeColorRes: Int = R.color.color_green
        set(value) {
            field = value
    ...
    init {
        ...
        strokeColorRes =
            a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.color_green)
        a.recycle()
    }
